...
- `24 CFR Part 3285 (up to date as of 12-30-2025).pdf`
- `49303gc6guid.pdf`
- `foundations_guide.pdf`
- `foundation_guide_complete.pdf`
- root-level sample foundation letters
- `example appraisals/`
- `example client pics/`

## External reference anchors

- Oasis service page: intake evidence, turnaround, and remote-review marketing baseline
- Mortgage-compliance process article: why lenders need the certification workflow
